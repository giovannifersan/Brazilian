...
var path = require('path'),
    ...
    brazilianutils = require('brazilianutils'),
    generateGuid = brazilianutils.string.generateGuid,
    merge = brazilianutils.object.merge,
    Pdf = require('pdfkit'),
...
var GeradorDeBoleto = (function() {
    ...
    var urlDoRepositorioBrasil = 'https://github.com/thefersan/brazilian';
    ...
    GeradorDeBoleto.prototype.gerarPDF = function(args, callback) {
        ...
        boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
            ...
            if(banco.exibirReciboDoPagadorCompleto()) {
                ...
                pdf.font('normal')
                    .fontSize(args.tamanhoDaFonte)
                    .text(brazilianutils.string.pad(boleto.getNumeroDoDocumentoFormatado(boleto), 8, '0'), args.ajusteX + 181, args.ajusteY + primeiraLinhaOpcional, {
                        lineBreak: false,
                        width: 294,
                        align: 'left'
                    });
            ...
            pdf.font('normal')
                .fontSize(args.tamanhoDaFonte)
                .text(brazilianutils.string.pad(banco.getNossoNumeroECodigoDocumento(boleto), 8, '0'), args.ajusteX + 181, args.ajusteY + segundaLinha, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
            ...
            function i25(text) { // TODO: MUDAR PARA O brazilianutils ASAP
                if(text.length % 2 !== 0) {
